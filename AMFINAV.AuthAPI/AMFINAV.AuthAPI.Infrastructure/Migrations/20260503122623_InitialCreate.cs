...
namespace AMFINAV.AuthAPI.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FamilyGroups_Users_HeadUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AddedByAdminId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "scheme.read", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "View scheme enrollment data", "Read Schemes" },
                    ...
                    { 6, "user.manage", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Approve, reject and manage user accounts", "Manage Users" },
                    { 7, "family.manage", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Create and manage family groups", "Manage Family Groups" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_FamilyGroups_HeadUserId",
                table: "FamilyGroups",
                column: "HeadUserId");
